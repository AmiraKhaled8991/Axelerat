...
namespace Axelerate.Application
{
    ...
    public class ExternalApp : IExternalApplication
    {
        ...
        public Result OnStartup(UIControlledApplication application)
        {
            ...
            PushButtonData btnTask1 = new PushButtonData("AddinBtn1", "Floor Create", path, "Axelerate.RevitCommand.FloorCommand")
            {
            ...
            PushButtonData btnTask2 = new PushButtonData("AddinBtn2", "Room Create", path, "Axelerate.Application.RoomCommand")
            {
                ToolTip = "Room Create",
                //Image = imgSrc,
                //LargeImage = imgSrc,
